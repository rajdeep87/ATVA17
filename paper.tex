...
number of decisions, propagations, and conflicts as well as \rmcmt{superior} runtimes 
compared to CBMC.  Compared to Astr{\'e}e, ACDLP is \rmcmt{?\%} more precise.  To 
the best of our knowledge, this is the first instantiation of CDCL with a template polyhedra 
abstract domain for safety verification.
%
\end{abstract}
