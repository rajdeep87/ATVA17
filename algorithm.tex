...
efficiency reasons.  Hence, it operates over an underapproximate domain of
conflict reasons.  A~conflict reason underapproximates a set of invalid or
safe traces.  The conflict analysis returns a learnt transformer (negation
of conflict reason) that over-approximate a set of valid and unsafe traces. 
...
We~present the ACDLP algorithm in subsequent section.
