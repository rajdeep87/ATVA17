...
an under-approximate domain of conflict reasons.  The conflict analysis returns a 
learnt transformer and the model search is repeated with this new transformer.  Else,
