...
\begin{definition}
  ...
  \vee u \not\models \formula \}$, \pscmt{TODO: I do not understand what the domain of $u$ is. Also, it is unclear what the co-domain of $\conf{}{}$ is.}that is, it adds abstract models to 
...
(y \leq -4, x \leq -3), (y \leq -3, x \leq -2), (y \leq -2, x < 0)\}$ \pscmt{TODO: I do not understand the notation (..,..). Please clarify.}.
...
is given by, $\abd{\formula}{\intervals}(y \leq -5)=(y \leq -2, x < 0)$ \pscmt{TODO: again, the notation is mysterious},
...
assignment $s$ \pscmt{TODO: Have you defined this terms in the context of domains? I don't understand the word ``assignment'' in the context of a relational domain.} in the conflict reason by a partial assignment that is sufficient 
