...
heuristically selecting a generalisation.  The main idea of abductive
...
Below, we define a global conflict transformer that gives set of models that 
do not satisfy a formula.  
\rmcmt{
\begin{definition}
...
%
An abstract abductive transformer, $\abd{}{}(a)$, corresponds to the 
under-approximatation of the global conflict transformer, $\conf{}{}$.
%
