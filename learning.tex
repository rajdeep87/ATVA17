...
Informally, an abstract abductive transformer, $\abd{}{}(A)$, for a given
formula $\formula$ adds abstract models to the input set $\allval$, that do
not satisfy $\formula$.
%
...
$\aunit$ for $\conflictset = \{x \geq 2, x \leq 5, y \leq 7 \}$ is shown
below.  \\
%
\Omit{
